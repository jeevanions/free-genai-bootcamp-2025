...
from components.youtube_transcript import create_youtube_transcript_interface
from components.whisper_transcript import create_whisper_transcript_interface
from components.ocr_extraction import create_ocr_interface
from components.rag_implementation import create_rag_interface
from components.interactive_learning import create_interactive_learning_interface
...
def start_backend():
    return {"url": "http://localhost:7860", "message": "Backend started successfully"}
